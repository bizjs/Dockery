...
type UserEdges struct {
	...
	Permissions []*RepoPermission `json:"permissions,omitempty"`
...
func (e UserEdges) PermissionsOrErr() ([]*RepoPermission, error) {
	if e.loadedTypes[0] {
...
func (u *User) QueryPermissions() *RepoPermissionQuery {
