...
type UserQuery struct {
	...
	withPermissions *RepoPermissionQuery
...
func (uq *UserQuery) QueryPermissions() *RepoPermissionQuery {
	query := (&RepoPermissionClient{config: uq.config}).Query()
...
func (uq *UserQuery) WithPermissions(opts ...func(*RepoPermissionQuery)) *UserQuery {
	query := (&RepoPermissionClient{config: uq.config}).Query()
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withPermissions; query != nil {
		if err := uq.loadPermissions(ctx, query, nodes,
			func(n *User) { n.Edges.Permissions = []*RepoPermission{} },
			func(n *User, e *RepoPermission) { n.Edges.Permissions = append(n.Edges.Permissions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadPermissions(ctx context.Context, query *RepoPermissionQuery, nodes []*User, init func(*User), assign func(*User, *RepoPermission)) error {
	...
	query.withFKs = true
	query.Where(predicate.RepoPermission(func(s *sql.Selector) {
